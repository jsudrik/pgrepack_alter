...
SELECT repack_alter.get_order_by('issue3_1_idx'::regclass::oid, 'issue3_1'::regclass::oid);
...
SELECT repack_alter.get_order_by('issue3_2_idx'::regclass::oid, 'issue3_2'::regclass::oid);
...
SELECT repack_alter.get_order_by('issue3_3_idx'::regclass::oid, 'issue3_3'::regclass::oid);
...
SELECT repack_alter.get_order_by('issue3_4_idx'::regclass::oid, 'issue3_4'::regclass::oid);
...
SELECT repack_alter.get_order_by('issue3_5_idx'::regclass::oid, 'issue3_5'::regclass::oid);
...
SELECT repack_alter.get_order_by('issue321_idx'::regclass::oid, 1);
SELECT repack_alter.get_order_by(1, 1);
